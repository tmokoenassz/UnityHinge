...
#[derive(Debug)]
pub struct UnityHingeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UnityHingeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UnityHinge processing");
    
    let mut processor = UnityHingeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UnityHingeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UnityHingeProcessor::new(false);
